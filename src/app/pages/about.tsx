...
const About = () => {
  return (
    <div id="about" className="w-full h-full min-h-[400px] sm:min-h-[600px] font-light border dark:border-neutral-900 shadow-custom dark:shadow-custom-dark flex flex-col justify-center items-center bg-black p-8">
