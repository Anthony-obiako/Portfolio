...
const About = () => {
  return (
    <div id="about" className="w-full h-full min-h-[400px] sm:min-h-[600px] font-light border border-neutral-300 dark:border-neutral-900 shadow-custom dark:shadow-custom-dark rounded-2xl flex flex-col justify-center items-center bg-white dark:bg-black p-8">
      <div className="justify-items-center mb-4 md:mb-16">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-6xl text-teal-200">About Me</h1>
      </div>
      <div className="justify-items-center sm:flex lg:mt-10">
        ...
        <div className="justify-items-center">
          <div className="flex flex-col gap-5 sm:flex-row items-center">
            <div className="border-2 border-solid border-teal-200 p-8 justify-items-center rounded-3xl text-center max-w-[300px] h-full sm:min-w-[300px text-sm md:text-lg">
              <Image
                src={experience}
                alt="experience"
                width={30}
          ...
          <p className="text-center mt-3 text-teal-50 leading-relaxed italic sm:mx-4 md:mx-6 md:text-2xl lg:mx-10 lg:text-3xl">
